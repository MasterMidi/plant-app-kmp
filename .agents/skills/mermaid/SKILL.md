---
name: mermaid
description: Generate Mermaid diagrams from user requirements. Use when asked to create or edit Mermaid flowcharts, sequence diagrams, class diagrams, ER diagrams, Gantt charts, or other Mermaid diagram types.
license: MIT
